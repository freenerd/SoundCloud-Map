...
API_RETRIES = 10
SOUNDCLOUD_API_URL = "http://api.sandbox-soundcloud.com"
# SOUNDCLOUD_API_URL = "http://localhost:64627"
...
API_QUERY_INTERVAL = 57600 # In which Interval in minutes is the backend scripts /backend-update called?
